...
public class CreateActionPanel extends javax.swing.JPanel implements ValidationStateChangedListener,ChangeListener {
    ...
    public void validationStateChanged(Object validatedObject) {
        if(panCreate.getStatus() == Validatable.VALID){
            Sperre sperre = EJBroker.getInstance().isLocked(panCreate.getCurrentFlurstueckSchluessel());
            if(sperre != null){
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(panCreate, javax.swing.GroupLayout.PREFERRED_SIZE, 351, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        lblStaedtisch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/lagis/ressource/icons/toolbar/current.png")));

        jLabel2.setText("Art des Flurst\u00fccks:");

        javax.swing.GroupLayout pKindLayout = new javax.swing.GroupLayout(pKind);
        pKind.setLayout(pKindLayout);
        pKindLayout.setHorizontalGroup(
            pKindLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pKindLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pKindLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addGroup(pKindLayout.createSequentialGroup()
                        .addComponent(lblStaedtisch)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(rbStaedtisch, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pKindLayout.setVerticalGroup(
            ...
            .addGroup(pKindLayout.createSequentialGroup()
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pKindLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pKindLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(rbAbteilungIX, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(lblAbteilungIX))
                    .addComponent(rbStaedtisch, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblStaedtisch))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(pKind, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pKind, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void rbStaedtischActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbStaedtischActionPerformed
        if(rbStaedtisch.isSelected()){
            isStaedtisch=true;
        }
    ...
    private void rbAbteilungIXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbAbteilungIXActionPerformed
        if(rbAbteilungIX.isSelected()){
            isStaedtisch=false;
        }
