 ...
 */
public class SplitActionChoosePanel extends javax.swing.JPanel implements ChangeListener,ValidationStateChangedListener {
    ...
    public void validationStateChanged(Object validatedObject) {
        ...
        String result = String.valueOf(spnSplitCount.getValue());
        try{
        ...
        if(mode.equals(SPLIT_ACTION_MODE)){
            if(panSplit.getStatus() == Validatable.VALID){
                Sperre sperre = EJBroker.getInstance().isLocked(panSplit.getCurrentFlurstueckSchluessel());
                if(sperre != null){
...
//    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(30, 30, 30)
                .addComponent(spnSplitCount, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panSplit, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(lblSplitResult)
                .addGap(14, 14, 14)
                .addComponent(spnSplitCount, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(14, 14, 14)
                .addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panSplit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
