 ...
 */
public class ChangeKindActionPanel extends javax.swing.JPanel implements ValidationStateChangedListener,ChangeListener{
    ...
    public void validationStateChanged(final Object validatedObject) {
        ...
        try{
            if(isDeactivated || (validatedObject != null && validatedObject instanceof FlurstueckChooser)){
                ...
                if(panChangeKind.getCurrentFlurstueckSchluessel().getFlurstueckArt().getBezeichnung().equals(FlurstueckArt.FLURSTUECK_ART_BEZEICHNUNG_STAEDTISCH)){
            ...
            if(rbStaedtisch.isSelected() || rbAbteilungIX.isSelected()){
                ...
                if(rbStaedtisch.getModel().equals(rbGroup.getSelection())){
                    if(panChangeKind.getCurrentFlurstueckSchluessel().getFlurstueckArt().getBezeichnung().equals(FlurstueckArt.FLURSTUECK_ART_BEZEICHNUNG_STAEDTISCH)){
                        ...
                        for(FlurstueckArt currentArt:EJBroker.getInstance().getAllFlurstueckArten()){
                            if(currentArt.getBezeichnung().equals(FlurstueckArt.FLURSTUECK_ART_BEZEICHNUNG_STAEDTISCH)){
                                newArt = currentArt;
                            }
                        }
                    }
                } else if(rbAbteilungIX.getModel().equals(rbGroup.getSelection())){
                    if(panChangeKind.getCurrentFlurstueckSchluessel().getFlurstueckArt().getBezeichnung().equals(FlurstueckArt.FLURSTUECK_ART_BEZEICHNUNG_ABTEILUNGIX)){
                        log.debug("Flurstück ist Abteilung IX zugeordnet");
                        wizardController.setProblem("Flurstück ist bereits Abteilung IX zugeordnet");
                        return;
                    } else {
                        for(FlurstueckArt currentArt:EJBroker.getInstance().getAllFlurstueckArten()){
                            if(currentArt.getBezeichnung().equals(FlurstueckArt.FLURSTUECK_ART_BEZEICHNUNG_ABTEILUNGIX)){
                                newArt = currentArt;
                            }
                        }
                    }
                ...
                Sperre sperre = EJBroker.getInstance().isLocked(panChangeKind.getCurrentFlurstueckSchluessel());
                if(sperre != null){
    ...
    private void initComponents() {
        ...
        lblStaedtisch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/lagis/ressource/icons/toolbar/historic.png")));

        lblAbteilungIX.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/lagis/ressource/icons/toolbar/historic_abteilungIX.png")));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(panChangeKind, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel2))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblStaedtisch)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(rbStaedtisch, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblAbteilungIX)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(rbAbteilungIX, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panChangeKind, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblStaedtisch)
                            .addComponent(rbStaedtisch, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(rbAbteilungIX, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(lblAbteilungIX, javax.swing.GroupLayout.Alignment.TRAILING)))
