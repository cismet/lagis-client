...
//                cg.drawImage(this.icons.getImage(), box.getWidth() - this.icons.getIconWidth() - offsetRight, offsetTop, null);
                // edit by mbrill : icon is drawn in the vertical center of the title

                cg.drawImage(this.icons.getImage(), box.getWidth() - this.icons.getIconWidth() - offsetRight, (panTitle.getHeight() / 2) + 3 - (this.icons.getIconHeight() / 2), null);            }
            bg.dispose();
            gg.dispose();
            cg.dispose();
            box.flush();
