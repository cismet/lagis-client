...
public class PlanPanel extends javax.swing.JPanel implements MouseListener {
    ...
    public PlanPanel(PlanTableModel tableModel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAddPlan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/lagis/ressource/icons/buttons/add.png")));
        ...
        btnRemovePlan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/lagis/ressource/icons/buttons/remove.png")));
        ...
        pnlKostenControls1Layout.setHorizontalGroup(
            ...
            .add(pnlKostenControls1Layout.createSequentialGroup()
                .add(btnAddPlan, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(btnRemovePlan, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(bntok, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
                .addContainerGap())
        );
        pnlKostenControls1Layout.setVerticalGroup(
            pnlKostenControls1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(pnlKostenControls1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE, false)
                .add(btnRemovePlan, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 27, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(btnAddPlan, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 27, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(bntok, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 27, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        );

        pnlKostenControls1Layout.linkSize(new java.awt.Component[] {btnAddPlan, btnRemovePlan}, org.jdesktop.layout.GroupLayout.VERTICAL);
    ...
    private void btnRemovePlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemovePlanActionPerformed
         int currentRow = tblPlan.getSelectedRow();
        if(currentRow != -1){
            //VerwaltungsTableModel currentModel = (VerwaltungsTableModel)tNutzung.getModel();
            tableModel.removePlan(((JXTable)tblPlan).getFilters().convertRowIndexToModel(((JXTable)tblPlan).getFilters().convertRowIndexToModel(currentRow)));            
